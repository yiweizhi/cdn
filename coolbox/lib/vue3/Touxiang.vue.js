"use strict";
const Touxiang_vue_vue_type_script_lang = require("./Touxiang.vue2.js");
const vue = require("vue");
require("./Touxiang.vue3.js");
const _pluginVue_exportHelper = require("../_virtual/_plugin-vue_export-helper.js");
const _withScopeId = (n) => (vue.pushScopeId("data-v-4026a67f"), n = n(), vue.popScopeId(), n);
const _hoisted_1 = ["width", "height", "spin", "rtl"];
const _hoisted_2 = { fill: "none" };
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("rect", {
  "fill-opacity": ".01",
  fill: "#FFF",
  opacity: ".01",
  width: "32",
...
const Touxiang = /* @__PURE__ */ _pluginVue_exportHelper(Touxiang_vue_vue_type_script_lang, [["render", _sfc_render], ["__scopeId", "data-v-4026a67f"]]);
